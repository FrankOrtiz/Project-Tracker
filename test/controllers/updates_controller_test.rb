...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { description: @update.description, project_id: @update.project_id, who: @update.who }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { description: @update.description, project_id: @update.project_id, who: @update.who }
    assert_redirected_to update_path(assigns(:update))
  end
